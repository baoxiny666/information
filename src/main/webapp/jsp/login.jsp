...
<body>
	...
	<div class="login_kuang">
		<div border="0" width="300px" height="400px"   style="background: url(../static/img/bg_login.png) repeat;background-color:#fff;overflow:hidden;border:2px solid #F0FFFF">
		   <div style="width:100%;height:10px"></div>
		   <div class="topimage">
				<img style="width:65px;height:65px;" src="../static/img/peoplePic.png">
		   </div>
		   <div style="width:100%;height:10px"></div>
			   ...
			   <div class="loginbutton">
			   		...
			   		<button class="daanniu" onclick="loginCheck()"  >登录</button>
			   </div>
