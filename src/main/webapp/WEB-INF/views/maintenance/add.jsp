...
<link rel="stylesheet" type="text/css" href="<%=basePath%>static/maintenance/css/add.css">
<title>质保书维护</title>
<script type="text/javascript">
...
　　　　　　　　validator: function(value,param){
					...
					　　　　　　　　type: 'POST',
					        		async:false,
					　　　　　　　　url:basePath+'/user/userValidate.do',
					　　　　　　　　dataType:'json',
					　　　　　　　　data:{uname:value},
					　　　　　　　　async:false,
	...
	<form id="ff" method="post" style="line-height: 59px; " enctype="multipart/form-data" target="dummyiframe">
	 	<div class="kuang">
            ...
            <div  class="valuesstyle">
                <input  class="easyui-validatebox"  data-options="required:true,validType:'accountexsit'"   
                                type="text" id="uname" name="uname"   placeholder="用户名"/>
            </div>
        </div>
        <div class="kuang">
            <div class="titlestyle">密码: </div>
            <div  class="valuesstyle">
                <input  class="easyui-validatebox"  data-options="required:true" type="text" id="upassword" validType="passwordkuang" name="upassword" placeholder="密码"/>
            </div>
        </div>
        <div class="kuang">
        ...
        <div class="kuang">
            ...
            <div  class="valuesstyle">
                <input  class="easyui-validatebox"  data-options="required:true" type="text" id="company" validType="company"  name="company" placeholder="所属公司"/>
            </div>
        </div>
    </form>
...
<script type="text/javascript" src="<%=basePath%>static/maintenance/js/add.js"></script>
<script type="text/javascript">
	<%-- $("#uname").validatebox({
	    required: true,
	    validType: [
	        "usercontent",
	        "remote['<%=basePath%>/user/userValidate.do','uname']"
	    ]
	}); --%>
</script>
</html>