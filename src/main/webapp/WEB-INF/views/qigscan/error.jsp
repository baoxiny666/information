...
<meta charset="UTF-8">
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>static/qigscan/css/error.css">
	<link rel="stylesheet" type="text/css" href="<%=basePath%>static/css/bootstrap.css">
	<title>错误</title>
	<style type="text/css">
	</style>
</head>
<body style="width:100%;height:100%;background-attachment: fixed; overflow-x: hidden; overflow-y: hidden;margin: 0;
	display: flex;
